    ...
    <section className="relative min-h-screen flex flex-col justify-center px-5 sm:px-10 max-w-7xl mx-auto">
      ...
      >
        ...
        >
          IT Business Analyst
          <br />
          <span className="text-[#c8a96e]">& Software Developer</span>
        </motion.h1>
        ...
        >
          Bridging business needs and technology solutions through requirement
          analysis, stakeholder collaboration, and data-driven decision making.
        </motion.p>
